...
func LoadConfig() *Config {
	config := &Config{
		AppName:  "validation-cli",
		Debug:    getEnvBool("VALIDATION-CLI_DEBUG", false),
		Quiet:    getEnvBool("VALIDATION-CLI_QUIET", false),
		Format:   getEnvString("VALIDATION-CLI_FORMAT", "text"),
		LogLevel: getEnvString("VALIDATION-CLI_LOG_LEVEL", "info"),
	}
