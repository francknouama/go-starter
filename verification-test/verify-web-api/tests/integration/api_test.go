...
import (
	...
	"github.com/verify/web-api/internal/handlers"
	"github.com/verify/web-api/internal/logger"
	"github.com/verify/web-api/internal/middleware"
)
...
func (suite *APITestSuite) SetupSuite() {
	...
	var err error
	suite.logger, err = loggerFactory.CreateFromProjectConfig("slog", "error", "text", false)
